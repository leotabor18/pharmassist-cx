  ...
  const onSubmitOtp = (code: string) => {
    ...
    setTimeout(() => {
      if (code === item.code?.toString()) {
        router.push({pathname : '/sign-up', params: { phoneNumber: item.phoneNumber }})
      ...
      <ThemeProvider  value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
        <Surface style={styles.mainContainer} >
          ...
          />
           ...
           <ThemedText style={styles.description} type='subtitle'>OTP is sent to your mobile number: {item?.phoneNumber }</ThemedText>
